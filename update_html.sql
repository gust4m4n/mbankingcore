-- Update Terms & Conditions with HTML format
UPDATE configs SET 
    value = '<h1>SYARAT DAN KETENTUAN PENGGUNAAN MBANKINGCORE</h1>
...
-- Update Privacy Policy with HTML format
UPDATE configs SET 
    value = '<h1>KEBIJAKAN PRIVASI MBANKINGCORE</h1>
